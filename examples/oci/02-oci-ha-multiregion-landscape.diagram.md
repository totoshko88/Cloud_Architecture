---
id: oci-ha-multiregion-landscape-v1
title: OCI HA Multi-Region — Landscape (as-built)
...
summary_of: 02-oci-ha-multiregion-summary
tags:
  - oci
  - ha
  - multi-region
  ...
  - landscape-asbuilt
related_docs:
  - 02-oci-ha-multiregion-summary.diagram.md
---

# OCI HA Multi-Region — Landscape (as-built)

## Overview

This is the `landscape`-class as-built of the OCI active-passive multi-region
workload in Compartment acme-prod. Where the paired summary shows the shape, this diagram shows
...
satisfying `edge-routing`. Every node uses a resolved OCI icon.
...
This as-built pairs with `02-oci-ha-multiregion-summary.drawio` — the twelve-node-or-fewer `flow` summary of
