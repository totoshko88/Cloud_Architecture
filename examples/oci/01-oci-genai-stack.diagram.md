...
node style points at a placeholder rather than a resolved embedded OCI stencil (or
the OCI-red labelled-box fallback) from the OCI icon mapping. A `companion-doc` error means this `.diagram.md` file is
