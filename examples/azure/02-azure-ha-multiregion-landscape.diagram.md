---
id: azure-ha-multiregion-landscape-v1
title: Azure HA Multi-Region — Landscape (as-built)
...
summary_of: 02-azure-ha-multiregion-summary
tags:
  - azure
  - ha
  - multi-region
  ...
  - landscape-asbuilt
related_docs:
  - 02-azure-ha-multiregion-summary.diagram.md
---

# Azure HA Multi-Region — Landscape (as-built)

## Overview

This is the `landscape`-class as-built of the Azure active-passive multi-region
workload in Subscription contoso-prod. Where the paired summary shows the shape, this diagram shows
what is actually deployed: two regions (eastus primary, westus2 passive), each with
...
satisfying `edge-routing`. Every node uses a resolved Azure icon.
...
This as-built pairs with `02-azure-ha-multiregion-summary.drawio` — the twelve-node-or-fewer `flow` summary of
