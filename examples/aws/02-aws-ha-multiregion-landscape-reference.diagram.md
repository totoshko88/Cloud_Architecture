---
id: aws-ha-multiregion-landscape-v1
title: AWS HA Multi-Region — Landscape (as-built)
...
summary_of: 02-aws-ha-multiregion-summary
tags:
  - aws
  - ha
  - multi-region
  ...
  - landscape-asbuilt
related_docs:
  - 02-aws-ha-multiregion-summary.diagram.md
---

# AWS HA Multi-Region — Landscape (as-built)

## Overview

This is the `landscape`-class as-built of the AWS active-passive multi-region
workload in Account 111122223333. Where the paired summary shows the shape, this diagram shows
what is actually deployed: two regions (us-east-1 primary, us-west-2 passive), each with
...
satisfying `edge-routing`. Every node uses a resolved AWS icon.
...
This as-built pairs with `02-aws-ha-multiregion-summary.drawio` — the twelve-node-or-fewer `flow` summary of
